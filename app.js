  ...
  ReactRouter.match({ routes: routes, location: req.url }, function (err, redirectLocation, renderProps) {
    ...
    if (renderProps) {
      ...
      Promise.all(promises).then(function (data) {
        var _glamor$renderStatic = glamor.renderStatic(function () {
          return ReactDOM.renderToString(React.createElement(ReactRouter.RouterContext, _extends({}, renderProps, {
            ...
            html = _glamor$renderStatic.html,
            css = _glamor$renderStatic.css;

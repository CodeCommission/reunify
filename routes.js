  ...
  <Route
    ...
    getComponent={(location, cb) => {
      try {
        ...
        if (err && err.message && err.message.indexOf('Cannot') !== -1)
          return cb(null, require('./pages/Layout').default);
            ...
            .concat([
              {
                ...
                getComponent: (location, cb) => {
                  try {
                    ...
                    if (err && err.message && err.message.indexOf('Cannot') !== -1)
                      return cb(null, require('./pages/NotFound').default);
    ...
    <IndexRoute
      getComponent={(location, cb) => {
        try {
          ...
          if (err && err.message && err.message.indexOf('Cannot') !== -1)
            return cb(null, require('./pages/Index').default);
